    ...
    async fn search_transfers_impl(
        ...
        let query = format!(
            ...
            FROM (
                SELECT
                    ...
                    recipient_account,
                    NULL::TEXT as ticker,
                    NULL::INT as source_token_root_wc,
                    NULL::TEXT as source_token_root_account,
                    value,
                    status,
                    created_at
                FROM transfers
        ...
        let transfers = rows
            ...
            .map(|row| TransferFromDb {
                ...
                token_address_wc: row.get("source_token_root_wc"),
                token_address_account: row.get("source_token_root_account"),
